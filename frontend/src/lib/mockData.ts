...
export const mockOrganizations: Organization[] = [
  ...
  },
  {
    ...
    description:
      "Connecting developers across Japan through workshops and networking events.",
    descriptionJa:
      "ワークショップやネットワーキングイベントを通じて日本全国の開発者をつなぐ組織です。",
    imageUrl:
      "https://images.pexels.com/photos/3861972/pexels-photo-3861972.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    nameJa: "AI研究コレクティブ",
    description:
      "Advancing AI research and education through collaborative events.",
...
export const mockOrgEvents: Event[] = [
  {
    ...
    description:
      "Join us for a 48-hour hackathon focused on sustainable technology solutions.",
  ...
  },
  {
    ...
    description:
      "Intensive 3-day bootcamp covering React Native development from basics to advanced.",
  ...
  },
  {
    ...
    description:
      "Explore the future of Web3 and blockchain technology with industry experts.",
...
export const mockOrgMembers: OrgMember[] = [
  // Tokyo Tech Innovators (org-1) members
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/3861972/pexels-photo-3861972.jpeg?auto=compress&cs=tinysrgb&w=800",
    description:
      "テクノロジーを通じて社会課題を解決することに情熱を注いでいます。",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/3861972/pexels-photo-3861972.jpeg?auto=compress&cs=tinysrgb&w=800",
    description:
      "UX/UIデザイナーとして、ユーザー中心のデザインを追求しています。",
...
export const getMembersByOrganization = (
  organizationId: string,
): OrgMember[] => {
  return mockOrgMembers.filter(

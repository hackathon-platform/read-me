...
const DUMMY_EVENTS = [
  {
    ...
    description:
      "Join us for the biggest tech conference of the year! Featuring keynote speakers from leading tech companies, workshops on the latest technologies, and networking opportunities.",
  ...
  },
  {
    ...
    description:
      "A three-day music festival featuring top artists from around the world. Experience amazing performances, food vendors, and art installations.",
  ...
  },
  {
    ...
    description:
      "Connect with fellow entrepreneurs, investors, and industry experts. Perfect opportunity to showcase your startup and meet potential partners.",
  ...
  },
  {
    ...
    description:
      "Join our annual charity run to support education initiatives. Choose between 5K, 10K, or half marathon distances. All proceeds go to local schools.",
  ...
  },
  {
    ...
    description:
      "Experience stunning artworks from contemporary artists exploring their vision of future cities. Features paintings, sculptures, and digital art.",
  ...
  },
  {
    ...
    description:
      "Learn the latest web development technologies in this hands-on workshop. Perfect for beginners and intermediate developers.",
    location: "Online",
    category: "Workshop",
    ...
    async function fetchEvents() {
      try {
        ...
        if (
          ...
          filteredEvents = filteredEvents.filter(
            (event) => event.category === searchParams.category,
          );
        }

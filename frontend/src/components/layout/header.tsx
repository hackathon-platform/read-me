...
import { CalendarDays, User, LogOut, Code2, ChevronDown } from "lucide-react";

export default function Header() {
  const { user, signOut, loading } = useSupabase();

  const headerClasses = `
    sticky top-0 z-50 w-full transition-all duration-300 bg-transparent border-b border-border
  `;

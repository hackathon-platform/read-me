            ...
            {fields.map((field, idx) => (
              ...
              >
                <Button
                  ...
                  onClick={() => remove(idx)}
                  disabled={isSaving}
                  className="absolute -top-2 -left-2 h-6 w-6 p-0 rounded-full bg-background border border-border/60  text-muted-foreground hover:text-destructive hover:bg-destructive hover:text-destructive-foreground hover:border-destructive shadow-sm transition-all duration-200 z-10"
                  title="この学歴を削除"
                >
